...
from train_model import CNN_LSTM_Model  # Imports your model class as defined in train_model.py
import joblib
import os
...
# --- Transform Using the Loaded X_scaler and y_scaler ---
...
# Convert Predictions to NumPy and reshape to (n_samples, 1)
y_pred_scaled = y_pred_tensor.cpu().numpy().reshape(-1, 1)

# Inverse transform predictions and actual values using y_scaler
